...
proc create_root_design { parentCell } {
  ...
  set csi_mipi_phy_if0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:mipi_phy_rtl:1.0 csi_mipi_phy_if0 ]
  set csi_mipi_phy_if1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:mipi_phy_rtl:1.0 csi_mipi_phy_if1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.Input_Data_Width {384} \
   CONFIG.Output_Data_Width {384} \
  ...
  # Create instance: pxp_0, and set properties
  set pxp_0 [ create_bd_cell -type ip -vlnv x38:x38:pxp:1.0 pxp_0 ]

  # Create instance: pxp_axi_slave_0, and set properties
  set pxp_axi_slave_0 [ create_bd_cell -type ip -vlnv x38:x38:pxp_axi_slave:1.0 pxp_axi_slave_0 ]
 ...
 ] [get_bd_intf_pins /pxp_axi_slave_0/s_axi_cnt]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {49.995} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hpm1_M00_AXI [get_bd_intf_pins axi_interconnect_hpm1/M00_AXI] [get_bd_intf_pins pxp_axi_slave_0/s_axi_cnt]
  ...
  connect_bd_net -net clk_150mhz [get_bd_pins axi_interconnect_hpm1/ACLK] [get_bd_pins axi_interconnect_hpm1/M00_ACLK] [get_bd_pins axi_interconnect_hpm1/M01_ACLK] [get_bd_pins axi_interconnect_hpm1/M02_ACLK] [get_bd_pins axi_interconnect_hpm1/M03_ACLK] [get_bd_pins axi_interconnect_hpm1/M04_ACLK] [get_bd_pins axi_interconnect_hpm1/M05_ACLK] [get_bd_pins axi_interconnect_hpm1/M06_ACLK] [get_bd_pins axi_interconnect_hpm1/M07_ACLK] [get_bd_pins axi_interconnect_hpm1/M08_ACLK] [get_bd_pins axi_interconnect_hpm1/M09_ACLK] [get_bd_pins axi_interconnect_hpm1/M10_ACLK] [get_bd_pins axi_interconnect_hpm1/M11_ACLK] [get_bd_pins axi_interconnect_hpm1/M12_ACLK] [get_bd_pins axi_interconnect_hpm1/M13_ACLK] [get_bd_pins axi_interconnect_hpm1/M14_ACLK] [get_bd_pins axi_interconnect_hpm1/M15_ACLK] [get_bd_pins axi_interconnect_hpm1/M16_ACLK] [get_bd_pins axi_interconnect_hpm1/M17_ACLK] [get_bd_pins axi_interconnect_hpm1/M18_ACLK] [get_bd_pins axi_interconnect_hpm1/S00_ACLK] [get_bd_pins clk_wiz_1/clk_out4] [get_bd_pins fifo_generator_0/clk] [get_bd_pins pxp_0/aclk] [get_bd_pins pxp_axi_slave_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk]
  connect_bd_net -net clk_50mhz [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins clk_wiz_1/locked] [get_bd_pins proc_sys_reset_1/dcm_locked]
  connect_bd_net -net fifo_generator_0_dout [get_bd_pins fifo_generator_0/dout] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_10/Din] [get_bd_pins xlslice_11/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din] [get_bd_pins xlslice_4/Din] [get_bd_pins xlslice_5/Din] [get_bd_pins xlslice_6/Din] [get_bd_pins xlslice_7/Din] [get_bd_pins xlslice_8/Din] [get_bd_pins xlslice_9/Din]
  connect_bd_net -net fifo_generator_0_empty [get_bd_pins fifo_generator_0/empty] [get_bd_pins pxp_axi_slave_0/fifo_empty]
  connect_bd_net -net gpio_Dout [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0]
  connect_bd_net -net proc_sys_reset_clk50_interconnect_aresetn [get_bd_pins axi_interconnect_hpm1/ARESETN] [get_bd_pins proc_sys_reset_1/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_clk50_peripheral_aresetn [get_bd_pins axi_interconnect_hpm1/M00_ARESETN] [get_bd_pins axi_interconnect_hpm1/M01_ARESETN] [get_bd_pins axi_interconnect_hpm1/M02_ARESETN] [get_bd_pins axi_interconnect_hpm1/M03_ARESETN] [get_bd_pins axi_interconnect_hpm1/M04_ARESETN] [get_bd_pins axi_interconnect_hpm1/M05_ARESETN] [get_bd_pins axi_interconnect_hpm1/M06_ARESETN] [get_bd_pins axi_interconnect_hpm1/M07_ARESETN] [get_bd_pins axi_interconnect_hpm1/M08_ARESETN] [get_bd_pins axi_interconnect_hpm1/M09_ARESETN] [get_bd_pins axi_interconnect_hpm1/M10_ARESETN] [get_bd_pins axi_interconnect_hpm1/M11_ARESETN] [get_bd_pins axi_interconnect_hpm1/M12_ARESETN] [get_bd_pins axi_interconnect_hpm1/M13_ARESETN] [get_bd_pins axi_interconnect_hpm1/M14_ARESETN] [get_bd_pins axi_interconnect_hpm1/M15_ARESETN] [get_bd_pins axi_interconnect_hpm1/M16_ARESETN] [get_bd_pins axi_interconnect_hpm1/M17_ARESETN] [get_bd_pins axi_interconnect_hpm1/M18_ARESETN] [get_bd_pins axi_interconnect_hpm1/S00_ARESETN] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins pxp_axi_slave_0/resetn] [get_bd_pins util_vector_logic_0/Op1]
  connect_bd_net -net pxp_0_R_11 [get_bd_pins pxp_0/R_11] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net pxp_0_R_12 [get_bd_pins pxp_0/R_12] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net pxp_0_R_13 [get_bd_pins pxp_0/R_13] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net pxp_0_R_21 [get_bd_pins pxp_0/R_21] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net pxp_0_R_22 [get_bd_pins pxp_0/R_22] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net pxp_0_R_23 [get_bd_pins pxp_0/R_23] [get_bd_pins xlconcat_0/In5]
  connect_bd_net -net pxp_0_R_31 [get_bd_pins pxp_0/R_31] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net pxp_0_R_32 [get_bd_pins pxp_0/R_32] [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net pxp_0_R_33 [get_bd_pins pxp_0/R_33] [get_bd_pins xlconcat_0/In8]
  connect_bd_net -net pxp_0_t_1 [get_bd_pins pxp_0/t_1] [get_bd_pins xlconcat_0/In9]
  connect_bd_net -net pxp_0_t_2 [get_bd_pins pxp_0/t_2] [get_bd_pins xlconcat_0/In10]
  connect_bd_net -net pxp_0_t_3 [get_bd_pins pxp_0/t_3] [get_bd_pins xlconcat_0/In11]
  connect_bd_net -net pxp_0_valid_out [get_bd_pins fifo_generator_0/wr_en] [get_bd_pins pxp_0/valid_out]
  connect_bd_net -net pxp_axi_slave_0_R2_11 [get_bd_pins pxp_0/R2_11] [get_bd_pins pxp_axi_slave_0/R2_11]
  connect_bd_net -net pxp_axi_slave_0_R2_12 [get_bd_pins pxp_0/R2_12] [get_bd_pins pxp_axi_slave_0/R2_12]
  connect_bd_net -net pxp_axi_slave_0_R2_13 [get_bd_pins pxp_0/R2_13] [get_bd_pins pxp_axi_slave_0/R2_13]
  connect_bd_net -net pxp_axi_slave_0_R2_21 [get_bd_pins pxp_0/R2_21] [get_bd_pins pxp_axi_slave_0/R2_21]
  connect_bd_net -net pxp_axi_slave_0_R2_22 [get_bd_pins pxp_0/R2_22] [get_bd_pins pxp_axi_slave_0/R2_22]
  connect_bd_net -net pxp_axi_slave_0_R2_23 [get_bd_pins pxp_0/R2_23] [get_bd_pins pxp_axi_slave_0/R2_23]
  connect_bd_net -net pxp_axi_slave_0_R2_31 [get_bd_pins pxp_0/R2_31] [get_bd_pins pxp_axi_slave_0/R2_31]
  connect_bd_net -net pxp_axi_slave_0_R2_32 [get_bd_pins pxp_0/R2_32] [get_bd_pins pxp_axi_slave_0/R2_32]
  connect_bd_net -net pxp_axi_slave_0_R2_33 [get_bd_pins pxp_0/R2_33] [get_bd_pins pxp_axi_slave_0/R2_33]
  connect_bd_net -net pxp_axi_slave_0_a1 [get_bd_pins pxp_0/a1] [get_bd_pins pxp_axi_slave_0/a1]
  connect_bd_net -net pxp_axi_slave_0_a2 [get_bd_pins pxp_0/a2] [get_bd_pins pxp_axi_slave_0/a2]
  connect_bd_net -net pxp_axi_slave_0_b1 [get_bd_pins pxp_0/b1] [get_bd_pins pxp_axi_slave_0/b1]
  connect_bd_net -net pxp_axi_slave_0_b2 [get_bd_pins pxp_0/b2] [get_bd_pins pxp_axi_slave_0/b2]
  connect_bd_net -net pxp_axi_slave_0_c1 [get_bd_pins pxp_0/c1] [get_bd_pins pxp_axi_slave_0/c1]
  connect_bd_net -net pxp_axi_slave_0_c2 [get_bd_pins pxp_0/c2] [get_bd_pins pxp_axi_slave_0/c2]
  connect_bd_net -net pxp_axi_slave_0_d1 [get_bd_pins pxp_0/d1] [get_bd_pins pxp_axi_slave_0/d1]
  connect_bd_net -net pxp_axi_slave_0_d2 [get_bd_pins pxp_0/d2] [get_bd_pins pxp_axi_slave_0/d2]
  connect_bd_net -net pxp_axi_slave_0_e1 [get_bd_pins pxp_0/e1] [get_bd_pins pxp_axi_slave_0/e1]
  connect_bd_net -net pxp_axi_slave_0_e2 [get_bd_pins pxp_0/e2] [get_bd_pins pxp_axi_slave_0/e2]
  connect_bd_net -net pxp_axi_slave_0_pop [get_bd_pins fifo_generator_0/rd_en] [get_bd_pins pxp_axi_slave_0/pop]
  connect_bd_net -net pxp_axi_slave_0_push [get_bd_pins pxp_0/valid_in] [get_bd_pins pxp_axi_slave_0/push]
  connect_bd_net -net pxp_axi_slave_0_row1 [get_bd_pins pxp_0/row1] [get_bd_pins pxp_axi_slave_0/row1]
  connect_bd_net -net pxp_axi_slave_0_row2 [get_bd_pins pxp_0/row2] [get_bd_pins pxp_axi_slave_0/row2]
  connect_bd_net -net pxp_axi_slave_0_t2_1 [get_bd_pins pxp_0/t2_1] [get_bd_pins pxp_axi_slave_0/t2_1]
  connect_bd_net -net pxp_axi_slave_0_t2_2 [get_bd_pins pxp_0/t2_2] [get_bd_pins pxp_axi_slave_0/t2_2]
  connect_bd_net -net pxp_axi_slave_0_t2_3 [get_bd_pins pxp_0/t2_3] [get_bd_pins pxp_axi_slave_0/t2_3]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins pxp_axi_slave_0/R_11] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_10_Dout [get_bd_pins pxp_axi_slave_0/t_2] [get_bd_pins xlslice_10/Dout]
  connect_bd_net -net xlslice_11_Dout [get_bd_pins pxp_axi_slave_0/t_3] [get_bd_pins xlslice_11/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins pxp_axi_slave_0/R_12] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins pxp_axi_slave_0/R_13] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins pxp_axi_slave_0/R_21] [get_bd_pins xlslice_3/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins pxp_axi_slave_0/R_22] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_5_Dout [get_bd_pins pxp_axi_slave_0/R_23] [get_bd_pins xlslice_5/Dout]
  connect_bd_net -net xlslice_6_Dout [get_bd_pins pxp_axi_slave_0/R_31] [get_bd_pins xlslice_6/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins pxp_axi_slave_0/R_32] [get_bd_pins xlslice_7/Dout]
  connect_bd_net -net xlslice_8_Dout [get_bd_pins pxp_axi_slave_0/R_33] [get_bd_pins xlslice_8/Dout]
  connect_bd_net -net xlslice_9_Dout [get_bd_pins pxp_axi_slave_0/t_1] [get_bd_pins xlslice_9/Dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0xB0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs pxp_axi_slave_0/interface_aximm/reg0] SEG_pxp_axi_slave_0_reg0
